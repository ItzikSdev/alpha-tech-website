...
const PLAN_DATA: Record<string, {
  ...
  alphacar_basic_tokens: {
    ...
    features: {
      he: ['50 הודעות AI', 'פרסום עד 2 מכוניות', 'חיפוש AI בסיסי'],
      en: ['50 AI messages', 'Up to 2 listings', 'Basic AI search'],
      ru: ['50 AI сообщений', 'До 2 объявлений', 'Базовый AI-поиск'],
    },
    priceILS: 15,
    priceUSD: 4.1,
    period: null,
  ...
  alphacar_pro_monthly: {
    ...
    features: {
      he: ['הודעות AI ללא הגבלה', '5 פרסומי מכוניות', 'תג מוכר מאומת', 'עדיפות בתוצאות חיפוש', 'קידום אוטומטי ברשתות כל שבוע'],
      en: ['Unlimited AI messages', '5 car listings', 'Verified seller badge', 'Priority in search', 'Weekly auto social media promotion'],
      ru: ['Безлимитные AI сообщения', '5 объявлений', 'Значок продавца', 'Приоритет в поиске', 'Еженедельное продвижение в соцсетях'],
    },
    priceILS: 20,
    priceUSD: 5.4,
  ...
  alphacar_premium_tokens: {
    ...
    features: {
      he: ['150 הודעות AI', 'פרסום עד 4 מכוניות', 'חיפוש AI מתקדם'],
      en: ['150 AI messages', 'Up to 4 listings', 'Advanced AI search'],
      ru: ['150 AI сообщений', 'До 4 объявлений', 'Расширенный AI-поиск'],
    },
    priceILS: 30,
    priceUSD: 8.1,
    period: null,
